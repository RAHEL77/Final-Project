...
const addApartment = async (req, res) => {
    ...
    const apartment = await ApartmentModel.findOne({ numOfApartment: numOfApartment });
    if (apartment) {
      res.status(422);
    ...
    const newApartment = new ApartmentModel({ numOfApartment,floor,sizeOfApartment,userId  });
